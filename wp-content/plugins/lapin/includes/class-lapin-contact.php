...
final class Lapin_Contact {
	...
	public function handle(): void {
		...
		// Reply hits the person who submitted the form. The sender NAME shown
		// to the recipient ("Lapin Negotiation Services") is set once, site-wide,
		// by the wp_mail_from_name filter registered in lapin.php.
